  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-3 border-b border-neutral-200">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-black">Verifikasi</h1>
          <p className="text-xs text-neutral-500">Antrean telaah dan putusan berkas administrasi peserta</p>
        </div>
      </div>
