...
export default function VillagesPage() {
  ...
  const handleBulkDelete = async () => {
    if (!confirm(`Hapus ${selectedIds.length} desa terpilih?`)) return;
    setBulkLoading(true);
    try {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-3 border-b border-neutral-200">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-black">Desa</h1>
          <p className="text-xs text-neutral-500">Master data desa / kelurahan kecamatan</p>
        </div>
                  ...
                  <tr key={item.id} className="hover:bg-neutral-50 transition-colors">
                    ...
                    <td className="px-4 py-2.5 text-right space-x-1">
                      ...
                      <Button
                        ...
                        className="p-1.5 text-black hover:bg-neutral-100"
                        aria-label="Hapus"
                      >
        ...
        <div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {items.map((item) => (
              <div
                key={item.id}
                className="bg-white border border-neutral-200 p-4 rounded hover:border-black transition-colors relative flex flex-col justify-between"
              >
                <div>
                  ...
                  <div className="flex items-center gap-1.5 font-semibold text-sm text-black">
