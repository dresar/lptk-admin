...
import { ArrowLeft, Save, Upload, Newspaper, Sparkles, CheckCircle2, Image as ImageIcon } from 'lucide-react';
...
export default function NewPostPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    excerpt: '',
    content: '',
    cover_image_url: '/api/cdn/posts/jadwal-mtq-xix.jpg',
    ...
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      ...
      <div className="flex items-center justify-between pb-4 border-b border-neutral-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-neutral-500">
              Buat artikel warta, pengumuman, juknis, atau kabar kafilah untuk dipublikasikan
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/admin/posts"
            className="px-4 py-2 text-xs font-semibold text-neutral-600 hover:text-black border border-neutral-200 rounded-lg hover:bg-neutral-100 transition-colors"
          >
            Batal
          </Link>
          <Button
        ...
        <div className="bg-white border border-neutral-200 rounded-2xl p-6 space-y-5 shadow-xs">
          <div>
            ...
            <input
              ...
              placeholder="Contoh: Jadwal Pembukaan MTQ XIX Tambusai Utara 2026 di Desa Mahato"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="jadwal-pembukaan-mtq-xix-2026"
          ...
          <div className="pt-2 border-t border-neutral-100">
            ...
            <textarea
              ...
              placeholder="Tuliskan 1 hingga 2 kalimat ringkasan yang akan tampil pada kartu berita publik..."
          ...
          <div className="pt-2 border-t border-neutral-100">
            ...
            <textarea
              ...
              placeholder="Tuliskan isi berita, pengumuman, atau petunjuk teknis secara lengkap..."
